    ...
    <div class="card">
        ...
        <form method="POST" action="{{ route('anggota.store') }}">
            ...
            <div class="form-group">
                ...
                <input id="nama_depan" name="nama_depan" type="text" class="form-input" value="{{ old('nama_depan') }}" required autofocus />
                @error('nama_depan')
            ...
            <div class="form-group">
                ...
                <input id="nama_belakang" name="nama_belakang" type="text" class="form-input" value="{{ old('nama_belakang') }}" />
                @error('nama_belakang')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input id="gelar_depan" name="gelar_depan" type="text" class="form-input" value="{{ old('gelar_depan') }}" />
                @error('gelar_depan')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input id="gelar_belakang" name="gelar_belakang" type="text" class="form-input" value="{{ old('gelar_belakang') }}" />
            ...
            <div class="form-group">
                ...
                <input id="jumlah_anak" name="jumlah_anak" type="number" min="0" class="form-input" value="{{ old('jumlah_anak', 0) }}" required />
                @error('jumlah_anak')
                    <div class="error-message">{{ $message }}</div>
                @enderror
            </div>
