             ...
             <tbody>
                @forelse ($payrolls as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('payrolls.show', $item->id_anggota) }}" class="link-action link-detail" style="color: green;">Lihat Detail</a>
                            <a href="{{ route('payrolls.edit', $item->id_anggota) }}" class="link-action link-edit">Ubah</a>
                            <form action="{{ route('payrolls.destroy', $item->id_anggota) }}" method="POST" class="inline-form" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data penggajian ini?');">
                                @csrf
                                @method('DELETE')
