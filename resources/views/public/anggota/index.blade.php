...
<header class="header">
    <div class="header-content">
        <h2>{{ __('Data Anggota DPR RI (Read Only)') }}</h2>
    </div>
</header>
...
<div class="container">
    <div class="card">
        ...
        <div class="header-section">
            <h3 style="font-size: 1rem; color: #4b5563;">Daftar Anggota Aktif</h3>
            
            <form method="GET" action="{{ route('public.anggota.index') }}" class="search-form">
